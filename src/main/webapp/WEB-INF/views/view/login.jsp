									...
									<div class="menu">
										<div class="tabmenu">
											<input type="radio" name="tab" id="tab1"> <input
												type="radio" name="tab" id="tab2"> <input
												type="radio" name="tab" id="tab3" checked="checked">
											<input type="radio" name="tab" id="tab4">
											<div class="tab_menu">
												<label for="tab1">협력사</label> <label for="tab2">고객사</label>
												<label for="tab3">임직원</label> <label for="tab4">관리자</label>
											</div>
											<div class="tab1_content tab_content">
												<div class="text-center">
													<h1 class="h4 text-gray-900 mb-4">CREDITOR LOGIN</h1>
												...
												<form action="/main" method="POST">
													<div class="form-group">
														<input id="" class="form-control form-control-user"
															type="text" placeholder="회원 코드" name="id" required>
													</div>
													<div class="form-group">
														<input id="" class="form-control form-control-user"
															type="password" placeholder="패스워드" name="pw" required>
													</div>
													<button class="btn btn-primary btn-user btn-block"
														type="submit">협력사 로그인</button>
													<input type="hidden" name="group_GB" value="cr">
												</form>
												<hr>
												<div class="text-center">
											...
											<div class="tab3_content tab_content">
												...
												<form action="/main" method="POST">
													<div class="form-group">
														<input id="" class="form-control form-control-user"
															type="text" placeholder="사원 아이디" name="id" required>
													</div>
													<div class="form-group">
														<input id="" class="form-control form-control-user"
															type="password" placeholder="패스워드" name="pw" required>
											...
											<div class="tab4_content tab_content">
												...
												<form action="/main" method="POST">
													<div class="form-group">
														<input id="" class="form-control form-control-user"
															type="text" placeholder="관리자 코드" name="id" required>
													</div>
													<div class="form-group">
														<input id="" class="form-control form-control-user"
															type="password" placeholder="패스워드" name="pw" required>
